...
const ProfileSeeker = () => {
  ...
  const {
    ...
    error: jobsError,
    data: jobsData,
  } = useQuery(GET_JOBS_APPLIED_BY_SEEKER);
  ...
  if (jobsLoading)
    return <p className="animate-pulse">Loading applied jobs...</p>;
  if (jobsError)
    return <p>Error loading applied jobs. Please try again later.</p>;
